        ...
        <section className={`space-y-6 ${className}`}>
            <header>
                ...
                <p className="mt-1 text-sm text-gray-600">
                    Dès que votre compte est supprimé, toutes ses ressources et
            ...
            <Modal show={confirmingUserDeletion} onClose={closeModal}>
                <form onSubmit={deleteUser} className="p-6">
                    ...
                    <p className="mt-1 text-sm text-gray-600">
                        Dès que votre compte est supprimé, toutes ses ressources
                        et données seront définitivement supprimées. Veuillez
                        entrer votre mot de passe pour confirmer que vous
